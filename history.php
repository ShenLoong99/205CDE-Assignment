<?php 
    ...
    $view_chap = array();
    $up_chap = array();
    $sql = "SELECT m.image, m.manga_name, l.manga_id, l.current_chap FROM library l, manga m WHERE l.id = ".$_SESSION["id"]." AND m.manga_id = l.manga_id AND l.history = true";
    ...
    if(isset($_POST['del_but'])){ // when click remove button
        ...
        $sql = "UPDATE library SET history = false WHERE manga_id = $del_id AND id = ".$_SESSION["id"]."";
        $con->query($sql);
                            ...
                            echo '<div class="card">
                                    <div class="p-5 border-left border-success border-w">
                                        <div class="info text-center">
                                            <span class="font-weight-bold" style="color: #FF4500;">There is nothing here... Did you not read any of the mangas??? &#128546; &#128546;</span>
                                        </div>
                                    </div>
                                  </div>';
                        }
