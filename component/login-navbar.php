            ...
            <div class="row mb-1">
                <form class="form-inline" name='search' action='search.php'>
                    ...
                    <div class="md-form my-0">
                        <input name="search" autocomplete="off" value="<?php if(isset($_GET['search'])) { echo $_GET['search']; } ?>" class="form-control mr-sm-2 shadow-none search" type="text" required placeholder="Search Manga..." aria-label="Search">
                    </div>
                </form>
                <a href="user.php">
